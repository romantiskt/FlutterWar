...
object StatusBarUtil {
    ...
    fun setColor(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            //如果设置为白色，就不处理了，避免和状态栏白色文字混为一体
            if (Color.WHITE == color) return
            activity.window
    ...
    fun setGradientColor(activity: Activity, view: View) {
        ...
        val fakeStatusBarView =
            decorView.findViewById<View>(R.id.custom)
    ...
    private val isFlyme4: Boolean
        private get() = (Build.FINGERPRINT.contains("Flyme_OS_4") || Build.VERSION.INCREMENTAL.contains(
            "Flyme_OS_4"
        )
                || Pattern.compile(
            "Flyme OS [4|5]",
    ...
    private fun setTranslucentView(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            var translucentView =
                viewGroup.findViewById<View>(R.id.custom)
